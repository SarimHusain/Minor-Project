...
def postprocess_qa_predictions(tokenizer, examples, features, raw_predictions):
    n_best_size = defaults["n_best_size"]
    max_answer_length = defaults["max_answer_length"]
...
def validate(dataset, trainer, tokenizer):
    # A sort of higher-order function
    ...
    metric = load_metric(defaults["dataset"])
